...
The node is published on npm as [`n8n-nodes-apidirect`](https://www.npmjs.com/package/n8n-nodes-apidirect) and covers 80 operations across Twitter/X, Facebook, Instagram, TikTok, YouTube, Reddit, Threads, Truth Social, Amazon, Trustpilot, and Google (web search, AI Mode, news, forums, and Maps/Places).
