...
| `posts[].ai_label` | object | Instagram's AI label: `detection_method` (how Instagram applied it, e.g. `"SELF_DISCLOSURE_FLOW"`, `"C2PA_METADATA"`, `"NONE"`). `label` is not returned on this endpoint (`null`) |
